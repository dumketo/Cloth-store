<style type="text/css">
    ...
    .buttons-con .action-link-wrap a { background: #68c950; padding: 8px 25px; border-radius: 4px; color: #FFF; font-weight: bold; font-size: 14px; -webkit-transition: all 0.3s linear; transition: all 0.3s linear; cursor: pointer; text-decoration: none; margin-right: 10px; }
    ...
    #Polygon-4,
    #Polygon-4,
    #Polygon-5 { -webkit-animation: float 1s infinite ease-in-out alternate; animation: float 1s infinite ease-in-out alternate; }
...
<div class="message-box">
    ...
    <div class="buttons-con">
        <div class="action-link-wrap">
            ...
            <a href="<?php echo home_url(); ?>" class="link-button">Go to Home Page</a>
        </div>
    </div>
</div>